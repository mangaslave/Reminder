...
export default class ReminderApp {
    ...
    /*
        ...
        */
            if (this._remindersHandler.size() === 0) {
             ...
             const id = parseInt(this.getUserChoice("number", true));
             this._remindersHandler.toggleCompletion(id);
             Logger.log('\n  🏁   Reminder Completion Toggled');
  }
  ...
  private handleModifyReminders(): void {
    /*
       ...
       Logger.logReminders(this._remindersHandler.reminders);
       const id = parseInt(this.getUserChoice("number", true));
       const desc = this.getUserChoice("new description", false);
       this._remindersHandler.modifyReminder(id, desc);
  ...
  private handleAddReminder(): void {
    /*
            ...
            ( 4 ) Logger.log('\n  🏁  Reminder Added');
        */
      const newDescription = this.getUserChoice("remider", false);
      ...
      this._remindersHandler.addReminder(newDescription, newTag);
      Logger.log('\n  🏁  Reminder Added');
  ...
  private handleSearchReminders(): void {
    ...
    */
    ...
    const key = this.getUserChoice("keyword", false);
    Logger.logSearchResults(this._remindersHandler.search(key));
